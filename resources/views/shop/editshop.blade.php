        ...
        <div class="uk-width-medium-1-2">
            <div class="uk-panel uk-panel-box uk-panel-box-secondary">
                <div class="uk-panel uk-panel-header">
                    ...
                    <form id="editshop-form" method="post" action="/shop/<?php echo $poi['_id']; ?>/edit" enctype="multipart/form-data" class="uk-form uk-form-stacked">
...
<?php $count = 0;
$cats = $poi['cat'];
foreach ($cats as $c) { ?> <!-- Begin foreach $scats -->
    ...
    <?php } ?> <!-- End foreach $shop_cat -->
                                            ...
                                            <div class="uk-width-2-5">
                                                <select class="uk-width-1-1" name="cat_sub_<?php echo $count; ?>" id="cat_sub_<?php echo $count; ?>">
                                                    ...
                                                    <?php foreach ($shop_cat as $key => $scat) {
                                                        $main = $scat['main'];
                                                        $sub = $scat['sub']; ?> <!-- Begin foreach $shop_cat -->
        <?php foreach ($sub as $s) {
            if ($scat['main'] == $c['main']) { ?> <!-- Begin foreach $sub & if -->
                                        ...
                                        <?php } ?> <!-- End foreach $shop_cat -->
                                            ...
                                            <div class="uk-width-1-5" style="visibility: <?php if ($count == 0) echo "hidden;";
                                        else echo "visible;"; ?>">
                                                <a href="" onclick="javascript:removeElement('cat_row_<?php echo $count; ?>');
    ...
    <?php $count++;
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-width-1-1">
                                <input type="text" class="uk-width-1-1"  id="keyword" name="keyword" value="<?php $keywords = $poi['keyword'];
$str = "";
foreach ($keywords as $k) {
    $str = $str . "$k, ";
} echo $str;  //echo $poi['keyword'];  ?>" /> 
...
foreach ($imgs as $img) { ?>
                                    ...
                                    <div id="files_row_<?php echo $count; ?>" class="uk-grid uk-form-row" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-5" style="visibility: <?php if ($count == 0) echo "hidden;";
                                            ...
                                            <a href="" onclick="javascript:delFile('files_row_<?php echo $count; ?>');
                                                        return false;">Remove</a>
                                        </div>
                                    </div>
    <?php $count++;
